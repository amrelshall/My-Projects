...
# تحديد المسافه بين كل نقطه و المساحه الي متجمع فيها اغلب النقط
# بنقيس متوسط تجمع النقط تحت جرس الجاوسين وهي دي مساحه تجمع اغلب النقط
# لو مش فاكر الداله راجع المحاضره الخامسه في كورس البايثون جزء مكتبه scipy
dist = stats.norm(mu[0], sigma[0])
dist.pdf(X[:,0])[0:X.shape[0]]

# هنعمل مصفوفه اصفار ونحول كل قيمه فيها الي بعد كل نقطه عن مساحه تجمع اغلب النقط
# هنقارن كل قيمه في المصفوفه بقيمه epsilon
